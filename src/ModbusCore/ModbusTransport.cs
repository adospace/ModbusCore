...
namespace ModbusCore
{
    ...
    //{
    //    public ReadRequestMessage(byte address, ModbusFunctionCode functionCode, int zeroBasedOffset, int count)
    //    {
    //        Address = address;
    ...
    //    public int ZeroBasedOffset { get; }
    //    public int Count { get; }
    //}

    //public class ReadResponseMessage : ModbusMessage
    //{
    //    public ReadResponseMessage(ReadRequestMessage requestMessage, MessageBufferSpan receivedBuffer)
    //    {
    //        RequestMessage = requestMessage;
    //        ReceivedBuffer = receivedBuffer;
    //    }

    //    public ReadRequestMessage RequestMessage { get; }
    //    public MessageBufferSpan ReceivedBuffer { get; }
    //}

    //public class WriteSingleCoilRequestMessage : ModbusMessage
    //{
    //    public WriteSingleCoilRequestMessage(byte address, int zeroBasedOffset, bool value)
    //    {
    //        Address = address;
    //        ZeroBasedOffset = zeroBasedOffset;
    //        Value = value;
    ...
    //public class WriteSingleCoilResponseMessage : ModbusMessage
    //{
    //    public WriteSingleCoilResponseMessage(WriteSingleCoilRequestMessage requestMessage, bool value)
    //    {
    //        RequestMessage = requestMessage;
    //        Value = value;
    //    }
    ...
    //    public int ZeroBasedOffset { get; }
    //    public bool Value { get; }
    //    public WriteSingleCoilRequestMessage RequestMessage { get; }
    //}
