namespace ModbusCore
{
    public static class CrcUtils
    {
        ...
        public static ushort CRC16(MessageBuffer messageBuffer)
        {
            byte uchCRCHi = 0xFF; /* high CRC byte initialized */
            byte uchCRCLo = 0xFF; /* low CRC byte initialized  */
            int uIndex;           /* will index into CRC lookup*/
            int nCnt = 0;
            /* table*/

            var usDataLen = messageBuffer.Length;
            while (usDataLen-- > 0) /* pass through message buffer */
            {
                uIndex = uchCRCHi ^ messageBuffer[nCnt++]; /* calculate the CRC */
